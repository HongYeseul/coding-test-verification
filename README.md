...
소유자가 그룹 설정에서 디스코드 웹훅 주소를 붙여넣으면, 착석·퇴근·응원·검수가 일어날 때마다 그 채널에 한 줄씩 올라갑니다. 문장은 최근 활동과 같습니다 — `**예슬**님이 13:00에 착석했습니다.`, `**예슬**님이 퇴근했습니다. 4시간 20분`, `**A**님이 **B**님에게 응원을 보냈습니다.`, 반려는 이유를 인용까지 붙입니다. 웹훅 이름은 `도장 · 그룹이름`이라 한 채널에 여러 그룹을 받아도 구분됩니다.
