create index proofs_group_user_created_at_idx on public.proofs (group_id, user_id, created_at);

create function public.get_group_overview(target_group_id uuid)
